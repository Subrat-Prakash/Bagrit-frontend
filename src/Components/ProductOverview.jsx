...
export const ProductOverviewTwo = () => {
  ...
  useEffect(() => {
    const fetchInnovativeProdById = async () => {
      try {
        const response = await axios.get(`https://bagrit-backend.onrender.com/getInnovativeProd/${id}`, { withCredentials: true });
  ...
  const handleBuyNow = async () => {
    ...
    const clearCartResponse = await axios.delete(`https://bagrit-backend.onrender.com/buyEmpty`, { withCredentials: true });
    const response = await axios.post(
      `https://bagrit-backend.onrender.com/buyCart`,
      {
