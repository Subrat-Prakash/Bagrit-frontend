...
function ForgotPasswordPage() {
    ...
    const handleSubmitEmail = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('https://bagrit-backend.onrender.com/forgot_password', { email });
    ...
    const handleSubmitPasswordReset = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('https://bagrit-backend.onrender.com/reset-password', { token: resetToken, newPassword, email });
